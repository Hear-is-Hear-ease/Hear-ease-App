...
class RecordServiceOld {
  ...
  Future<bool> waitSound2(String tempFilePath, Function stopCallback) async {
    const tick = 60;
    const threshold = 100.0;
    ...
    while (true) {
      try {
        ...
        // 아이의 울음소리인지 판단한다.
        bool isBabyCry = await detectCry.isBabyCry(tempFilePath);
  ...
  Future<bool> waitSound3(String tempFilePath, Function stopCallback) async {
    const tick = 30;
    const threshold = 100.0;
    var sumAvgPower = 0.0;
